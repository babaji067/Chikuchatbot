...
HELP_BACK = [
    ...
    [
        InlineKeyboardButton(text="⌯ 𝛅ᴜᴘᴘᴏʀᴛ ⌯", url=f"https://t.me/chhoti_bot_support"),
...
ABOUT_BUTTON = [
    [
        InlineKeyboardButton("⌯ 𝛅ᴜᴘᴘσʀᴛ ⌯", url="https://t.me/chhoti_bot_support"),
        InlineKeyboardButton("⌯ ᴜᴘᴅᴧᴛє ⌯", url="https://t.me/messo_network")
    ],
    [
